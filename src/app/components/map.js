...
// FINAL FIX: Changed import path to match the actual filename 'firebase.js'
// Your firebase config file is located at: src/app/lib/firebase.js
import { db } from '../lib/firebase'; // <--- THIS IS THE CHANGE
import { collection, getDocs } from 'firebase/firestore';

// Fix for default marker icon issues with Webpack/Leaflet in JavaScript
